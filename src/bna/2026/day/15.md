...
- [Cloud (Run) Functions](https://cloud.google.com/functions) (to handle web requests)
- [BigQuery](https://docs.cloud.google.com/bigquery/docs) (to store and query unemployment data)
